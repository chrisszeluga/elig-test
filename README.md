<h1 align="center"><strong>Exploratory Eligibility API with Prisma</strong></h1>

<br />

<div>Based on a basic starter kit for a flexible GraphQL server for TypeScript.</div>
